...
export const profile = {
  ...
  role: "Full Stack Software Engineer | WEB, APP & AI",
  intro:
    "Desenvolvo soluções de ponta a ponta, conectando backend, frontend e infraestrutura para entregar sistemas confiáveis e fáceis de manter.",
